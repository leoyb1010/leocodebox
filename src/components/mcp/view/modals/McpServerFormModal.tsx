    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg border border-border bg-background">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-4">
          ...
          {isEditing && (
            <div className="rounded-lg border border-border bg-muted p-3 dark:border-border dark:bg-muted/50">
              ...
              {showProjectSelector && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-border bg-muted px-3 py-2 text-muted-foreground focus:border-info focus:ring-info dark:border-border dark:bg-muted dark:text-muted-foreground"
                    required
                  >
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full border px-3 py-2 ${
                  jsonValidationError ? 'border-destructive' : 'border-border dark:border-border'
                } rounded-lg bg-muted font-mono text-sm text-muted-foreground focus:border-info focus:ring-info dark:bg-muted dark:text-muted-foreground`}
                rows={8}
