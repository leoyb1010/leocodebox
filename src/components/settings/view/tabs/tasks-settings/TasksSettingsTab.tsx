    ...
    <div className="space-y-8">
      <SettingsSection title={t('mainTabs.tasks')}>
        {isCheckingInstallation ? (
          ...
          <>
            {!isTaskMasterInstalled && (
              <div className="rounded-xl border border-warning bg-warning p-4 dark:border-warning/50 dark:bg-warning/30">
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-warning dark:bg-warning/50">
                    <svg className="h-4 w-4 text-warning dark:text-warning" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <div className="mb-2 font-medium text-warning dark:text-warning">
                      {t('tasks.notInstalled.title')}
                    </div>
                    <div className="space-y-3 text-sm text-warning dark:text-warning">
                      <p>{t('tasks.notInstalled.description')}</p>

                      <div className="rounded-lg bg-warning p-3 font-mono text-sm dark:bg-warning/40">
                      ...
                      <div>
                        <a
                          ...
                          className="inline-flex items-center gap-2 text-sm font-medium text-info hover:text-info dark:text-info dark:hover:text-info"
                        >
