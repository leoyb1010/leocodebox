...
export default function TaskMasterPanel({ isVisible }: TaskMasterPanelProps) {
  ...
  return (
    <>
      ...
      {prdNotification && (
        <div className="fixed bottom-4 right-4 z-50 duration-slow animate-in slide-in-from-bottom-2">
          <div className="flex items-center gap-3 rounded-lg bg-success px-4 py-3 text-primary-foreground shadow-elevation-2">
