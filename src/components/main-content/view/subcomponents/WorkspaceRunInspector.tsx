  ...
  return (
    <aside className="leocodebox-run-inspector hidden w-60 flex-shrink-0 flex-col border-l border-border bg-card/35 xl:flex">
      <div className="border-b border-border px-4 py-3">
        <div className="text-[11px] font-medium text-muted-foreground">当前运行</div>
        <div className="mt-2 flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-1 text-[10px] text-primary">
              <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-current" />运行中
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="divide-y divide-border/70 text-xs">
        <div className="space-y-2.5 px-4 py-3">
          <div className="flex items-center gap-2 text-muted-foreground"><Cpu className="h-3.5 w-3.5" />{runningCount} 个本机任务</div>
          <div className="flex items-center gap-2 text-muted-foreground"><Clock3 className="h-3.5 w-3.5" />{activity.statusText || '正在处理任务'}</div>
          <div className="flex items-center gap-2 text-muted-foreground"><ShieldCheck className="h-3.5 w-3.5" />权限仅作用于本机</div>
        </div>
        <div className="px-4 py-3">
          <div className="mb-2 text-[11px] font-medium text-muted-foreground">工作目录</div>
