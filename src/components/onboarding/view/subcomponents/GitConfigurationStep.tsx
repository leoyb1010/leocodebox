      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-background/60 px-4 py-2.5 text-foreground shadow-elevation-1 transition-colors placeholder:text-muted-foreground/60 hover:border-foreground/20 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
