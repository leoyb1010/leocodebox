...
export default tseslint.config(
      ...
      "boundaries/elements": [
        ...
        },
        {
          ...
          pattern: [
            ...
            "server/shared/secret-box.{js,ts}",
        ...
        },
        {
          ...
          pattern: [
            "server/projects.js",
            "server/utils/runtime-paths.{js,ts}",
            "server/utils/mcp-detector.{js,ts}",
            "server/utils/taskmaster-websocket.{js,ts}",
  ...
  {
    // Tests intentionally reach into provider implementations and legacy
    // runtime adapters. They are verification clients, not production module
    // dependencies, so unknown/deep boundary classification is not actionable.
    files: ["server/**/tests/**/*.{js,ts}", "server/**/*.test.{js,ts}"],
    rules: {
