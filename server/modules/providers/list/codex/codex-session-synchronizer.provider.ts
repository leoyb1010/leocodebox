...
export class CodexSessionSynchronizer implements IProviderSessionSynchronizer {
  ...
  private async processSessionFile(
    ...
    // Sessions started by sending a message from leocodebox carry a distinct
   ...
   * they must be skipped here to stay out of the sidebar. Top-level sessions
   * carry thread_source "user" and a string source ("exec"/"cli"); sub-agents
   * carry thread_source "subagent" and an object source keyed by "subagent".
   * (Absorbed from upstream claudecodeui 1.36.3.)
   */
   ...
   * app-created sessions from the prompt the user sent from leocodebox.
   *
